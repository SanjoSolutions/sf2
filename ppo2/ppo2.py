...
def learn(*, network, env, total_timesteps, eval_env=None, seed=None, nsteps=2048, ent_coef=0.0, lr=3e-4,
    ...
    **network_kwargs:                 keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    for update in range(1, nupdates+1):
        ...
        # Get minibatch
        obs, returns, masks, actions, values, neglogpacs, states, epinfos, average_reward = runner.run(
        )  # pylint: disable=E0632
        if eval_env is not None:
            eval_obs, eval_returns, eval_masks, eval_actions, eval_values, eval_neglogpacs, eval_states, eval_epinfos, eval_average_reward = eval_runner.run()  # pylint: disable=E0632
        ...
        if update % log_interval == 0 or update == 1:
            ...
            logger.logkv('average_reward', average_reward)
            ...
            if eval_env is not None:
                logger.logkv('eval_average_reward', eval_average_reward)
